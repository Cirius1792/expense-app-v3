...
public class GroupStepDefinition {
    ...
    public void creates_the_group_with_the_members(String ownerUsername, String groupName, List<String> usernames) {
        ...
        this.newGroup = this.applicationDriver.createGroup(ownerUsername, groupName, usernames);
    ...
    public void isAddedToTheGroup(String username) {
        this.newGroup = addMembersToAGroupUseCase.addMember(this.newGroup.id(), List.of(this.users.get(username))).block();
    }
}
