...
public class GroupRouterConfig {
    ...
    @Bean
    RetrieveUserBalancePerGroupUseCase retrieveUserBalancePerGroupUseCase(PersonStore personStore, ExpenseChargeStore expenseChargeStore) {
    ...
    RouterFunction<ServerResponse> groupRoutes(
        ...
        return new GroupRouter(findGroupUseCase, createGroupUseCase, retrieveUserBalancePerGroupUseCase, groupMapper).createRoutes();
    }
}
