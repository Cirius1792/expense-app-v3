...
public class GroupRouter {
    ...
    public GroupRouter(
            ...
            RetrieveUserBalancePerGroupUseCase retrieveUserBalancePerGroupUseCase, GroupMapper groupMapper) {
    ...
    private Mono<ServerResponse> retrieveUserBalance(ServerRequest serverRequest) {
        ...
        return retrieveUserBalancePerGroupUseCase.retrieve(userId, groupId)
