...
public class GroupRouter {
    ...
    public GroupRouter(FindGroupUseCase findGroupUseCase, CreateGroupUseCase createGroupUseCase, GroupMapper groupMapper) {
    ...
    public RouterFunction<ServerResponse> createRoutes() {
        return route()
                ...
                .GET("/group/{groupId}",
                        this::retrieveGroup,
                        ops -> ops.operationId("retrieveGroupById")
                                .tag("Group")
                                ...
                                .response(responseBuilder()
                                        .responseCode("200")
                                        .implementation(GroupResponse.class))
                                .response(responseBuilder()
                                        .responseCode("404").description("No group found for the given id")))
                .build();
    }
    ...
    private Mono<ServerResponse> retrieveGroup(ServerRequest serverRequest) {
        ...
        return ServerResponse.ok()
                .body(findGroupUseCase.retrieve(groupId)
                        .map(groupMapper::toDto), GroupResponse.class);
    }
}
