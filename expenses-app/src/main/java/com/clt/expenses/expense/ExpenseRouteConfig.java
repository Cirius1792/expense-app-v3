...
public class ExpenseRouteConfig {
    ...
    @Bean
    FindExpensesPerGroupUseCase findExpensesPerGroupUseCase(ExpenseStore expenseStore, PersonStore personStore) {
    ...
    RouterFunction<ServerResponse> expensesRouter(
        ...
        return new ExpenseRouter(expenseMapper, addExpenseUseCase, findExpenseUseCase, findExpensesPerGroupUseCase).createRoutes();
    }
}
