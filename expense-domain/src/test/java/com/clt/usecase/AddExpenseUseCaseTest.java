...
class AddExpenseUseCaseTest {
    ...
    void initMocks() {
        ...
        Mockito.when(groupStore.retrieve(GROUP.id()))
    ...
    @DisplayName("Given a valid person" +
            "And a valid group " +
