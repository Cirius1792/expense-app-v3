...
public final class ImmutablePerson implements Person {
  ...
  private ImmutablePerson(String id, String username) {
    this.id = id;
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link Person#id() id} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for id
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePerson withId(String value) {
    String newValue = Objects.requireNonNull(value, "id");
    if (this.id.equals(newValue)) return this;
    return new ImmutablePerson(newValue, this.username);
  }

  /**
   * Copy the current immutable object by setting a value for the {@link Person#username() username} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for username
   * @return A modified copy of the {@code this} object
   */
  public final ImmutablePerson withUsername(String value) {
    String newValue = Objects.requireNonNull(value, "username");
    if (this.username.equals(newValue)) return this;
    return new ImmutablePerson(this.id, newValue);
  }
  ...
  public boolean equals(Object another) {
    ...
    return another instanceof ImmutablePerson
        && equalTo(0, (ImmutablePerson) another);
  }

  private boolean equalTo(int synthetic, ImmutablePerson another) {
   ...
   *    .id(String) // required {@link Person#id() id}
   *    .username(String) // required {@link Person#username() username}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    /**
     * Initializes the value for the {@link Person#id() id} attribute.
    ...
    /**
     * Initializes the value for the {@link Person#username() username} attribute.
    ...
    public ImmutablePerson build() {
      ...
      return new ImmutablePerson(id, username);
    }
